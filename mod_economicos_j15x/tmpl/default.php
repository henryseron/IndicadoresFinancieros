...
<div id="mod_economicos">
    ...
    ?>
    <br />
    <?php echo JText::_('MOD_ECONOMICOS_FUENTE'). "<a href=\"http://si3.bcentral.cl/Indicadoressiete/secure/Indicadoresdiarios.aspx\" target=\"_blank\">Banco Central de Chile</a>" ?>
    <br/>
